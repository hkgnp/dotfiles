...
_G.packer_plugins = {
  ...
  ["alpha-nvim"] = {
    loaded = true,
    path = "/Users/ben/.local/share/nvim/site/pack/packer/start/alpha-nvim",
    url = "https://github.com/goolord/alpha-nvim"
  },
  catppuccin = {
    loaded = true,
    path = "/Users/ben/.local/share/nvim/site/pack/packer/start/catppuccin",
  ...
  ["dwm.vim"] = {
    loaded = true,
    path = "/Users/ben/.local/share/nvim/site/pack/packer/start/dwm.vim",
  ...
  gruvbox = {
    loaded = true,
    path = "/Users/ben/.local/share/nvim/site/pack/packer/start/gruvbox",
    url = "https://github.com/morhetz/gruvbox"
  },
  ["indent-blankline.nvim"] = {
    loaded = true,
    path = "/Users/ben/.local/share/nvim/site/pack/packer/start/indent-blankline.nvim",
    url = "https://github.com/lukas-reineke/indent-blankline.nvim"
  },
  ["leap.nvim"] = {
    config = { "\27LJ\2\nA\0\0\3\0\3\0\0066\0\0\0'\2\1\0B\0\2\0029\0\2\0B\0\1\1K\0\1\0\25add_default_mappings\tleap\frequire\0" },
    loaded = true,
    path = "/Users/ben/.local/share/nvim/site/pack/packer/start/leap.nvim",
  ...
  ["nvim-ts-autotag"] = {
    ...
    loaded = true,
    path = "/Users/ben/.local/share/nvim/site/pack/packer/start/nvim-ts-autotag",
  ...
  ["sqlite.lua"] = {
    loaded = true,
    path = "/Users/ben/.local/share/nvim/site/pack/packer/start/sqlite.lua",
    url = "https://github.com/tami5/sqlite.lua"
  },
  tagbar = {
    loaded = true,
    path = "/Users/ben/.local/share/nvim/site/pack/packer/start/tagbar",
    url = "https://github.com/preservim/tagbar"
  },
  ["telescope-frecency.nvim"] = {
    config = { "\27LJ\2\nM\0\0\3\0\4\0\a6\0\0\0'\2\1\0B\0\2\0029\0\2\0'\2\3\0B\0\2\1K\0\1\0\rfrecency\19load_extension\14telescope\frequire\0" },
    loaded = true,
    path = "/Users/ben/.local/share/nvim/site/pack/packer/start/telescope-frecency.nvim",
    url = "https://github.com/nvim-telescope/telescope-frecency.nvim"
  },
  ["telescope-fzy-native.nvim"] = {
    loaded = true,
    path = "/Users/ben/.local/share/nvim/site/pack/packer/start/telescope-fzy-native.nvim",
  ...
  ["toggleterm.nvim"] = {
    loaded = true,
    path = "/Users/ben/.local/share/nvim/site/pack/packer/start/toggleterm.nvim",
  ...
  ["vim-dadbod"] = {
    ...
    config = { "\27LJ\2\n<\0\0\3\0\3\0\0066\0\0\0'\2\1\0B\0\2\0029\0\2\0B\0\1\1K\0\1\0\nsetup\19plugins.dadbod\frequire\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
    path = "/Users/ben/.local/share/nvim/site/pack/packer/opt/vim-dadbod",
    url = "https://github.com/tpope/vim-dadbod"
  },
  ["vim-dadbod-completion"] = {
    after_files = { "/Users/ben/.local/share/nvim/site/pack/packer/opt/vim-dadbod-completion/after/plugin/vim_dadbod_completion.lua", "/Users/ben/.local/share/nvim/site/pack/packer/opt/vim-dadbod-completion/after/plugin/vim_dadbod_completion.vim" },
    load_after = {
      ["vim-dadbod"] = true
    },
    loaded = false,
    needs_bufread = false,
    path = "/Users/ben/.local/share/nvim/site/pack/packer/opt/vim-dadbod-completion",
  ...
  ["vim-dadbod-ui"] = {
    ...
    loaded = false,
    needs_bufread = true,
    path = "/Users/ben/.local/share/nvim/site/pack/packer/opt/vim-dadbod-ui",
    url = "https://github.com/kristijanhusak/vim-dadbod-ui"
  },
  ["vim-fugitive"] = {
    loaded = true,
    path = "/Users/ben/.local/share/nvim/site/pack/packer/start/vim-fugitive",
    url = "https://github.com/tpope/vim-fugitive"
  },
  ["vim-mustache-handlebars"] = {
    loaded = true,
    path = "/Users/ben/.local/share/nvim/site/pack/packer/start/vim-mustache-handlebars",
...
pcall(vim.api.nvim_create_user_command, 'DBUI', function(cmdargs)
        ...
        {nargs = '*', range = true, bang = true, complete = function()
          require('packer.load')({'vim-dadbod'}, { cmd = 'DBUI' }, _G.packer_plugins)
...
pcall(vim.api.nvim_create_user_command, 'DBUIAddConnection', function(cmdargs)
        ...
        {nargs = '*', range = true, bang = true, complete = function()
          require('packer.load')({'vim-dadbod'}, { cmd = 'DBUIAddConnection' }, _G.packer_plugins)
...
pcall(vim.api.nvim_create_user_command, 'DBUIFindBuffer', function(cmdargs)
        ...
        {nargs = '*', range = true, bang = true, complete = function()
          require('packer.load')({'vim-dadbod'}, { cmd = 'DBUIFindBuffer' }, _G.packer_plugins)
...
pcall(vim.api.nvim_create_user_command, 'DBUIRenameBuffer', function(cmdargs)
        ...
        {nargs = '*', range = true, bang = true, complete = function()
          require('packer.load')({'vim-dadbod'}, { cmd = 'DBUIRenameBuffer' }, _G.packer_plugins)
...
pcall(vim.api.nvim_create_user_command, 'DBUILastQueryInfo', function(cmdargs)
        ...
        {nargs = '*', range = true, bang = true, complete = function()
          require('packer.load')({'vim-dadbod'}, { cmd = 'DBUILastQueryInfo' }, _G.packer_plugins)
...
pcall(vim.api.nvim_create_user_command, 'DBUIToggle', function(cmdargs)
        ...
        {nargs = '*', range = true, bang = true, complete = function()
          require('packer.load')({'vim-dadbod'}, { cmd = 'DBUIToggle' }, _G.packer_plugins)
