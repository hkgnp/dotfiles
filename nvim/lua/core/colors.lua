...
vim.api.nvim_command("let g:gruvbox_termcolors=256")
vim.api.nvim_command("let g:gruvbox_contrast_dark = 'soft'")
vim.api.nvim_command("let g:gruvbox_improved_warnings = 1")
vim.api.nvim_command("let g:gruvbox_improved_strings = 0")
